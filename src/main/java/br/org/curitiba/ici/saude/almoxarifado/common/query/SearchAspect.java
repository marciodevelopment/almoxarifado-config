...
import br.org.curitiba.ici.saude.almoxarifado.common.QueryDinamicaBuilder;
...
public class SearchAspect {
  ...
  @Around("@annotation(br.org.curitiba.ici.saude.almoxarifado.common.query.QuerySearch)")
